...
BONUSSOURCES = ft_lstnew_bonus.c ft_lstadd_back_bonus.c ft_lstadd_front_bonus.c ft_lstclear_bonus.c \
...
BONUSOBJECTS = \
	ft_lstnew_bonus.o ft_lstadd_back_bonus.o ft_lstadd_front_bonus.o ft_lstclear_bonus.o \
	ft_lstdelone_bonus.o ft_lstiter_bonus.o ft_lstlast_bonus.o ft_lstmap_bonus.o ft_lstsize_bonus.o
...
$(BONUSOBJECTS) : $(BONUSSOURCES)
	$(CC) $(CFLAGS) -c $(BONUSSOURCES)
